 ...
 */
class Elem : public ReferenceCountedObject<Elem>, public DofObject
{
protected:
  /**
...
public:
  ...
  /**
   * This function returns 1 if this is a fake neighbor of e, 0 otherwise.
   A fake neighbor is a neighbor not sharing any nodes with this element but still connected with it
   */
  unsigned int am_i_a_fake_neighbor(const Elem * e) const;
   ...
   */
  virtual unsigned int n_nodes_in_child(unsigned int /*c*/) const { return this->n_nodes(); }
   ...
   */
  unsigned int n_neighbors() const { return this->n_sides(); }
   ...
   */
  virtual unsigned int is_vertex_on_child(unsigned int /*c*/, unsigned int n) const
  {
...
public:
   ...
   */
  void
  active_family_tree_by_side(std::vector<Elem *> & family, unsigned int side, bool reset = true);
   ...
   */
  void
  total_family_tree_by_neighbor(std::vector<Elem *> & family, Elem * neighbor, bool reset = true);
   ...
   */
  void
  active_family_tree_by_neighbor(std::vector<Elem *> & family, Elem * neighbor, bool reset = true);
...
public:
   ...
   */
  virtual const std::vector<std::pair<unsigned char, unsigned char>> &
  parent_bracketing_nodes(unsigned int c, unsigned int n) const;

  /**
   * \returns All the pairs of nodes (indexed by global node id) which
   * should bracket node \p n of child \p c.
   */
  virtual const std::vector<std::pair<dof_id_type, dof_id_type>>
  bracketing_nodes(unsigned int c, unsigned int n) const;
...
// Elem helper classes
//
class Elem::NodeRefIter : public PointerToPointerIter<Node>
{
public:
  NodeRefIter(Node * const * nodepp) : PointerToPointerIter<Node>(nodepp) {}
};

class Elem::ConstNodeRefIter : public PointerToPointerIter<const Node>
{
public:
...
#ifdef LIBMESH_ENABLE_AMR
class Elem::ChildRefIter : public PointerToPointerIter<Elem>
{
public:
  ChildRefIter(Elem * const * childpp) : PointerToPointerIter<Elem>(childpp) {}
};

class Elem::ConstChildRefIter : public PointerToPointerIter<const Elem>
{
public:
  ConstChildRefIter(const Elem * const * childpp) : PointerToPointerIter<const Elem>(childpp) {}
};

inline SimpleRange<Elem::ChildRefIter>
Elem::child_ref_range()
{
  libmesh_assert(_children);
  return {_children, _children + this->n_children()};
}

inline SimpleRange<Elem::ConstChildRefIter>
Elem::child_ref_range() const
{
  libmesh_assert(_children);
  return {_children, _children + this->n_children()};
}
...
inline Elem::Elem(const unsigned int nn,
...
inline const Point &
Elem::point(const unsigned int i) const
{
...
inline Point &
Elem::point(const unsigned int i)
{
  libmesh_assert_less(i, this->n_nodes());
...
inline dof_id_type
Elem::node_id(const unsigned int i) const
{
  libmesh_assert_less(i, this->n_nodes());
  libmesh_assert(_nodes[i]);
  libmesh_assert_not_equal_to(_nodes[i]->id(), Node::invalid_id);
...
inline unsigned int
Elem::local_node(const dof_id_type i) const
{
...
inline const Node * const *
Elem::get_nodes() const
{
  return _nodes;
}

inline const Node *
Elem::node_ptr(const unsigned int i) const
{
  libmesh_assert_less(i, this->n_nodes());
  libmesh_assert(_nodes[i]);
...
inline Node *
Elem::node_ptr(const unsigned int i)
{
  libmesh_assert_less(i, this->n_nodes());
  libmesh_assert(_nodes[i]);
...
inline const Node &
Elem::node_ref(const unsigned int i) const
{
  return *this->node_ptr(i);
}

inline Node &
Elem::node_ref(const unsigned int i)
{
  return *this->node_ptr(i);
}

inline unsigned int
Elem::get_node_index(const Node * node_ptr) const
{
  for (auto n : make_range(this->n_nodes()))
...
inline Node *&
Elem::set_node(const unsigned int i)
{
  libmesh_assert_less(i, this->n_nodes());
...
inline subdomain_id_type
Elem::subdomain_id() const
{
  return _sbd_id;
}
...
inline const Elem *
Elem::neighbor_ptr(unsigned int i) const
{
...
inline void
Elem::set_neighbor(const unsigned int i, Elem * n)
{
  libmesh_assert_less(i, this->n_neighbors());
...
inline bool
Elem::has_neighbor(const Elem * elem) const
{
...
inline const Elem *
Elem::child_neighbor(const Elem * elem) const
{
  for (auto n : elem->neighbor_ptr_range())
    if (n && n->parent() == this)
      return n;
...
inline SimpleRange<Elem::NodeRefIter>
Elem::node_ref_range()
{
  return {_nodes, _nodes + this->n_nodes()};
}

inline SimpleRange<Elem::ConstNodeRefIter>
Elem::node_ref_range() const
{
  return {_nodes, _nodes + this->n_nodes()};
}

inline IntRange<unsigned short>
...
inline std::unique_ptr<const Elem>
Elem::side_ptr(unsigned int i) const
{
...
inline void
Elem::side_ptr(std::unique_ptr<const Elem> & elem, const unsigned int i) const
{
...
inline void
Elem::build_side_ptr(std::unique_ptr<const Elem> & elem, const unsigned int i) const
{
  // Hand off to the non-const version of this function
  Elem * me = const_cast<Elem *>(this);
  std::unique_ptr<Elem> e{const_cast<Elem *>(elem.release())};
...
template <typename Sideclass, typename Subclass>
inline std::unique_ptr<Elem>
Elem::simple_build_side_ptr(const unsigned int i, bool proxy)
{
...
template <typename Subclass>
inline void
Elem::simple_build_side_ptr(std::unique_ptr<Elem> & side, const unsigned int i, ElemType sidetype)
{
  libmesh_assert_less(i, this->n_sides());
...
template <typename Subclass, typename Mapclass>
inline void
Elem::simple_side_ptr(std::unique_ptr<Elem> & side, const unsigned int i, ElemType sidetype)
{
  libmesh_assert_less(i, this->n_sides());
...
inline unsigned int
Elem::which_neighbor_am_i(const Elem * e) const
{
  libmesh_assert(e);
...
inline unsigned int
Elem::am_i_a_fake_neighbor(const Elem * e) const
{
  libmesh_assert(e);

  const unsigned int master_side = this->which_neighbor_am_i(e);
  if (s != libMesh::invalid_uint)
  {
    // setup a container that will include all nodes globla ids on both sides
    std::vector<unsigned int> side_nodes = this->nodes_on_side(master_side);
    const unsigned int n_nodes_on_this_side = side_nodes.size();

    // search all nodes global ids on this element and add them to the container
    std::set<unsigned int> nodes_on_sides;
    for (unsigned int n = 0; n < n_nodes_on_this_side; n++)
      nodes_on_sides.insert(this->node_ptr(side_nodes[n])->id());

    // search all nodes global ids on e element and add them to the container
    const unsigned int other_side = e->which_neighbor_am_i(this);
    side_nodes = e->nodes_on_side(other_side);
    const unsigned int n_nodes_on_e_side = side_nodes.size();

    libmesh_assert(n_nodes_on_e_side == n_nodes_on_this_side);
    for (unsigned int n = 0; n < n_nodes_on_e_side; n++)
      nodes_on_sides.insert(e->node_ptr(side_nodes[n])->id());

    // if the size of the container is equal to twice the number of nodes on both sides then
    // this is a fake neighbor of e and vicenversa
    if (nodes_on_sides.size() == 2 * n_nodes_on_this_side) // this is a fake neighbor
      return 1;
...
{
#ifdef LIBMESH_ENABLE_AMR
  if ((this->refinement_flag() == INACTIVE) || (this->refinement_flag() == COARSEN_INACTIVE))
    return false;
  else
    return true;
#else
...
Elem::subactive() const
{
  ...
  if (!this->has_children())
    return true;
  for (const Elem * my_ancestor = this->parent(); my_ancestor != nullptr;
...
inline bool
Elem::has_ancestor_children() const
{
#ifdef LIBMESH_ENABLE_AMR
  if (_children == nullptr)
    return false;
...
inline bool
Elem::is_ancestor_of(const Elem *
#ifdef LIBMESH_ENABLE_AMR
                         descendant
#endif
                     ) const
...
inline ElemMappingType
Elem::mapping_type() const
{
  return static_cast<ElemMappingType>(_map_type);
}

inline void
Elem::set_mapping_type(const ElemMappingType type)
{
  _map_type = cast_int<unsigned char>(type);
}

inline unsigned char
Elem::mapping_data() const
{
  return _map_data;
}

inline void
Elem::set_mapping_data(const unsigned char data)
{
  _map_data = data;
}
...
inline const Elem *
Elem::raw_child_ptr(unsigned int i) const
{
  if (!_children)
    return nullptr;
...
inline const Elem *
Elem::child_ptr(unsigned int i) const
{
  libmesh_assert(_children);
...
inline void
Elem::set_child(unsigned int c, Elem * elem)
{
...
inline unsigned int
Elem::which_child_am_i(const Elem * e) const
{
  libmesh_assert(e);
  libmesh_assert(this->has_children());
...
inline Elem::RefinementState
Elem::refinement_flag() const
{
  return static_cast<RefinementState>(_rflag);
}

inline void
Elem::set_refinement_flag(RefinementState rflag)
{
  _rflag = cast_int<unsigned char>(rflag);
}

inline Elem::RefinementState
Elem::p_refinement_flag() const
{
  return static_cast<RefinementState>(_pflag);
}

inline void
Elem::set_p_refinement_flag(RefinementState pflag)
{
  if (this->p_level() == 0)
    libmesh_assert_not_equal_to(pflag, Elem::JUST_REFINED);

  _pflag = cast_int<unsigned char>(pflag);
}

inline unsigned int
Elem::max_descendant_p_level() const
{
  ...
  for (auto & c : child_ref_range())
    max_p_level = std::max(max_p_level, c.max_descendant_p_level());
  return max_p_level;
}

inline void
Elem::hack_p_level(unsigned int p)
{
  if (p == 0)
    libmesh_assert_not_equal_to(this->p_refinement_flag(), Elem::JUST_REFINED);
...
inline dof_id_type
Elem::compute_key(dof_id_type n0)
{
  return n0;
}

inline dof_id_type
Elem::compute_key(dof_id_type n0, dof_id_type n1)
{
...
inline dof_id_type
Elem::compute_key(dof_id_type n0, dof_id_type n1, dof_id_type n2)
{
...
inline dof_id_type
Elem::compute_key(dof_id_type n0, dof_id_type n1, dof_id_type n2, dof_id_type n3)
{
...
public:
  ...
  SideIter(const unsigned int side_number, Elem * parent)
    : _side(), _side_ptr(nullptr), _parent(parent), _side_number(side_number)
  {
  }

  // Empty constructor.
  SideIter() : _side(), _side_ptr(nullptr), _parent(nullptr), _side_number(libMesh::invalid_uint) {}

  // Copy constructor
  SideIter(const SideIter & other)
    : _side(), _side_ptr(nullptr), _parent(other._parent), _side_number(other._side_number)
  {
  }
  ...
  {
    return (this->_side_number == other._side_number && this->_parent == other._parent);
  }
  ...
  bool side_on_boundary() const { return this->_parent->neighbor_ptr(_side_number) == nullptr; }
 ...
 */
struct Elem::side_iterator : variant_filter_iterator<Elem::Predicate, Elem *>
{
...
inline SimpleRange<Elem::NeighborPtrIter>
Elem::neighbor_ptr_range()
{
  return {_elemlinks + 1, _elemlinks + 1 + this->n_neighbors()};
}

inline SimpleRange<Elem::ConstNeighborPtrIter>
Elem::neighbor_ptr_range() const
{
  return {_elemlinks + 1, _elemlinks + 1 + this->n_neighbors()};
}
...
#define LIBMESH_ENABLE_TOPOLOGY_CACHES                                                             \
  ...
  {                                                                                                \
    ...
    return c;                                                                                      \
                                                                                                   ...
                                                                                                   \
  virtual std::vector<std::vector<std::vector<signed char>>> & _get_parent_indices_cache()         \
      const override                                                                               \
  {                                                                                                \
    static std::vector<std::vector<std::vector<signed char>>> c;                                   \
    return c;                                                                                      \
